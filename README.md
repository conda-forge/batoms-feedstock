...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/batoms-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14268&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/batoms-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `batoms` can be installed with:

```
conda install batoms
```

It is possible to list all of the versions of `batoms` available on your platform with:
